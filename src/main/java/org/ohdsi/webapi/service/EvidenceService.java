 ...
 */
  ...
  */
  public static String getNegativeControlSql(NegativeControl task) {
    String sql = ResourceHelper.GetResourceAsString("/resources/evidence/sql/getNegativeControls.sql");
    ...
    String[] values = new String[]{tableQualifier, conceptIds, String.valueOf(task.getConceptSetId()), task.getConceptSetName(), task.getConceptDomainId(), task.getTargetDomainId(), String.valueOf(task.getSource().getSourceId())};
